...
class LED():
    ...
    def encrypt_block(self, pt: bytes, key: bytes, FAULTY=False, FAULTY_ROUND=12):
        """
        ...
        for step in range(12):
            ...
            for r in range(4):
                if FAULTY and step == FAULTY_ROUND-1 and r == 1:
                    state[rd.randint(0, 3)][rd.randint(0, 3)] = rd.randint(1, 15)
...
# print("ciphertext non fauté :", ct.hex())
# pt = cipher.decrypt_block(ct, key)
# print("ciphertext déchiffré :", pt.hex())

# ct = cipher.encrypt_block(pt, key, FAULTY=True)
# print("ciphertext fauté :", ct.hex())
